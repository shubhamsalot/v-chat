...
exports.onMatchmakingQueueCreated = void 0;
 ...
 */
exports.onMatchmakingQueueCreated = (0, firestore_1.onDocumentCreated)("matchmaking_queue/{uid}", async (event) => {
    ...
    const userInterests = joiningUser.interests || [];
    ...
    try {
        await db.runTransaction(async (transaction) => {
            ...
            if (freshJoining.data()?.status !== "waiting" ||
